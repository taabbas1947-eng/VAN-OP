...
const MARKERS = [
  ...
  ['<b>Terms and dates</b>',               1, 'New order in 4 sections, products as cards (25g)'],
  ['function screenHow(',                  1, 'How are we doing: the Dashboard for COO, CFO, Plant Manager (25h)'],
  ['function calDays(',                    1, 'dates as calendar days, Pakistan time (25m)'],
  ['var onTruck=0;',                        1, 'the same stock cannot be planned onto 2 trucks (25m)'],
  ['function budgetSplitKey(',              1, 'a budget per channel for a customer in 2 channels (25l)'],
