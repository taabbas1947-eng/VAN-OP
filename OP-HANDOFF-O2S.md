...
Pass 61 continued (same day, still 26c): Tahir's rulings — (1) Yield short: the Plant Manager reads and marks Seen, no send back; (2) a truck failing pre-shipment inspection: Supply Chain re-plans.
