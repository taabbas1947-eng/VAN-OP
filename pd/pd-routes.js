/* ============================================================================
 * PD (Product Development) routes — extracted from server.js on 2026-08-05.
 * Pure move: every handler and PD-only helper below is byte-identical to what
 * lived in server.js. Only this mount wrapper is new. server.js injects the
 * shared dependencies, so nothing here reaches into platform code directly.
 * ==========================================================================*/
